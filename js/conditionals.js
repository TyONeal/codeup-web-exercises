...
//         return("Yellow is the color of some flowers.");
//     } else if (colors === 'cyan') {
//         return("I don't know anything about Cyan.");
//     } else if (colors === 'green') {
//         return("Green is the color of healthy grass.");
...
const userColorResponse = prompt("What is your favorite color?");
const userColorAnalyzed = analyzeColor(userColorResponse);
console.log(userColorAnalyzed);
alert(userColorResponse + ' is my favorite color too!');
...
const userTotalBill = parseFloat(prompt("What is your total bill?"));
...
const userWantsToEnterANumber = confirm("Would you like to enter a number?");
    ...
    if (userWantsToEnterANumber) {
        ...
        if (typeof userNumber === 'number') {
            ...
            if (userNumber < 0) {
                ...
                alert("Your number is 0, therefore it is neither positive or negative.");
            }
        } else {
